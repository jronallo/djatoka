...
== IIIF Support
This gem can translate parameters from {International Image Interoperability Framework (IIIF)}[http://www-sul.stanford.edu/iiif/image-api/] requests into Djataka requests.  It follows the same pattern as creating a Djatoka::Region
